...
func update_description_panel() -> void:
	card_description = "[center][shake rate=2.0 level=1 connected=1]%s[/shake][/center]" % ("Deal [color=red]%d[/color] damage or gain [color=#008c10]%d[/color] HP." % [$DamageCardEffect.get_damage_amount(), $HealCardEffect.get_heal_amount()])
